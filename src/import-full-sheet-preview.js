...
(function () {
  ...
  function renderEntireSheetPreview() {
    ...
    headline.textContent = 'Se importará toda la hoja: ' + formatCount(importedRows.length) + ' filas · ' + formatCount(columns.length) + ' columnas';
    ...
    if (confirm) {
      ...
      confirm.textContent = importedRows.length ? ('Importar ' + formatCount(importedRows.length) + ' filas') : 'Sin datos para importar';
